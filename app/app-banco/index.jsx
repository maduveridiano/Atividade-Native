...
import OperacaoBanco from '../../components/OperacaoBanco';
import Imagem from '../../components/Imagem';

const AppBanco = function () {
    ...
    return (
        <View style={styles.container}>
            ...
            <OperacaoBanco onPress={Sacar} texto={'Sacar'} />
            <OperacaoBanco onPress={Depositar} texto={'Depositar'} />
        </View>
